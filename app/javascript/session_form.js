...
let getChallengeAndSubmitCredential = async function(form){
  ...
  console.log(credentialAuthenticationResponse)
  console.log(credentialFieldName)
  console.log(form.elements)
  console.log(form.elements[credentialFieldName])
  console.log(form.elements[credentialFieldName].value)
  console.log(JSON.stringify(credentialAuthenticationResponse))
